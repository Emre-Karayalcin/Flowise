    ...
    return (
        <>
            ...
            <Card sx={{ borderColor: theme.palette.primary[200] + 75, p: 3, mt: 2 }} variant='outlined'>
                ...
                {textField(title, 'title', 'Title', 'string', 'CODE Assistant')}
                {textField(
                    titleAvatarSrc,
                    'titleAvatarSrc',
                    'Title Avatar Link',
            ...
            <Card sx={{ borderColor: theme.palette.primary[200] + 75, p: 3, mt: 2 }} variant='outlined'>
                ...
                {isAgentCanvas && booleanField(showAgentMessages, 'showAgentMessages', 'Show agent reasonings when using Agents')}
